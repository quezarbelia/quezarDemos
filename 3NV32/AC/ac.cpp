...
void insercion(int arr_orig[], int n) {
    ...
    mA(arr, n, "Arreglo ordenado: ");
    std::cout << "\n--> Comparaciones realizadas: " << comparaciones;
    std::cout << "\n--> Movimientos (desplazamientos): " << movimientos << std::endl;
...
void busquedaBinaria(int arr[], int n) {
    ...
    if (encontrado) {
        std::cout << "-> Elemento " << dato << " encontrado en la posicion: " << mitad << std::endl;
    } else {
        std::cout << "-> Elemento " << dato << " no existe en el arreglo." << std::endl;
    }
    
    std::cout << "-> Comparaciones realizadas en busqueda: " << comparaciones << std::endl;
}
...
void busquedaSecuencial(int arr[], int n) {
    ...
    for (int i = 0; i < n; i++) {
        comparaciones++;
        if (arr[i] == dato) {
            std::cout << "-> Elemento " << dato << " encontrado en la posicion: " << i << std::endl;
            encontrado = true;
            break;
        }
    }
